...
const AdminNearbytypeEdit = (props) => {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_SERVER_URL}/admin/nearbytype/${params.id}`)
      .then((res) => {
  ...
  return (
    <div>
      <Helmet>
        <title>Acres - Real Estate React Template | Admin Near Type Edit</title>
        <meta name="description" content="#" />
      </Helmet>
      <AdminHeader />
      <AdminSider url={props.url} />
      <div className="text-center" style={{ margin: "20px" }}>
        <h2>Near Type Edit</h2>
      </div>
      <div
...
export default AdminNearbytypeEdit;
